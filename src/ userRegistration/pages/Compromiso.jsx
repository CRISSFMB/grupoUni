        ...
        <div className="form-container">
            ...
            <div className="commitments">
                ...
                <ol>
                    ...
                    <li>Para los estudiantes de segunda o superior matrícula: sé y acepto que la fecha de corte para el pago de la mensualidad es el día 10 de cada mes. Puedo solicitar aplazamientos dos días antes de esta fecha en Bienestar Estudiantil. Si no lo hago, asumiré lo que la normativa interna estipule al efecto. El impago acumulado de todas y cada una de las cuotas por más de 40 días puede ocasionar la pérdida del convenio de pagos para el siguiente semestre.</li>
                    ...
                    <li>Tengo conocimiento y acepto que en cada coordinación de carrera se me informará puntualmente de los procedimientos en relación a los trabajos, deberes, asistencia a clases y compromisos académicos con los que debo cumplir. Por otra parte, he sido informado y acepto que el Sistema de Gestión Académica continúa en periodo de pruebas y que solo serán válidas las notas que personalmente o públicamente comunique mi correspondiente coordinación de carrera.</li>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="button-group">
                    ...
                    <button onClick={() => handleSubmit('continuar')}>1.)Imprimir terminos y Condiciones</button>
                    <button onClick={() => handleSubmit('continuar')}>2.)Continuar Adminision</button>
