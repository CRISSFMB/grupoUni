      ...
      <form onSubmit={handleSubmit} className="formulario1">
        <div className="form-row">
          ...
          >
            ...
            <option value="TECNOLOGIA SUPERIOR EN ADMINISTRACION">
              Tecnología Superior en Administración
            </option>
            <option value="TECNOLOGIA EN PROCESAMIENTO DE ALIMENTOS">
              Tecnología en Procesamiento de Alimentos
            </option>
            <option value="TECNOLOGIA SUPERIOR EN AGROFORESTERIA">
              Tecnología Superior en Agroforestería
            </option>
            <option value="TECNOLOGIA EN ENFERMERIA">
              Tecnología en Enfermería
            </option>
            <option value="TECNOLOGIA EN CONSTRUCCION">
              Tecnología en Construcción
            </option>
            <option value="TECNOLOGIA SUPERIOR EN GASTRONOMIA">
              Tecnología Superior en Gastronomía
            </option>
            <option value="TECNOLOGIA SUPERIOR EN DESARROLLO DE SOFTWARE">
              Tecnología Superior en Desarrollo de Software
            </option>
            <option value="TECNOLOGIA SUPERIOR EN ELECTROMECANICA EN AUTOMOTRIZ">
              Tecnología Superior en Electromecánica en Automotriz
            </option>
          </select>
        </div>
